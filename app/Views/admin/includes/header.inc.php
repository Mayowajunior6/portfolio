      ...
      <div id="inner_container">
        <div id="navcontainer">
          ...
          <nav id="home_nav">
            ...
            <div id="nav_list">
              <ul id="navlist">
                <li><a <?=($slug == 'home') ? 'class="active"': ''?> href="/admin">Home</a></li>
                <li><a <?=($slug == 'users') ? 'class="active"': ''?> href="/admin/users">Users</a></li>
                <li><a <?=($slug == 'projects') ? 'class="active"': ''?> href="/admin/projects">Projects</a></li>
                <li><a <?=($slug == 'comments') ? 'class="active"': ''?> href="/admin/comments">Comments</a></li>
